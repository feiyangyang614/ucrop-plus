...
public class UCropActivity extends AppCompatActivity {
    ...
    private int mUCropViewOverlayImageResId;
    ...
    private void initiateRootViews() {
        ...
        if (mUCropViewOverlayImageResId != -1){
            mUCropView.setCropOverlayViewBg(mUCropViewOverlayImageResId);
            mUCropView.showCropOverlayView();
        }
    ...
    protected void cropAndSaveImage() {
        ...
        supportInvalidateOptionsMenu();
        if (mUCropView != null){
            mUCropView.hideCropOverlayView();
        }
